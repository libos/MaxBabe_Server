...
$caiyun_timestamp = date("Y") . "{$month}{$date}{$hour}";
$timestamp = date("Ymd");
$weather = array();
$primary_data = array();
if ($type == "all" || $type == "real_time" ) {
	...
	$primarylist  = array(	$key_temp,$key_weather,
							...
							"caiyun_hour_" . $id ."_". $caiyun_timestamp . "_aqi",
							"caiyun_hour_" . $id ."_". $caiyun_timestamp . "_humidity",
							"caiyun_hour_" . $id ."_". $caiyun_timestamp . "_wind_level",
							"caiyun_hour_" . $id ."_". $caiyun_timestamp . "_temperature",
							"caiyun_daily_" . $id ."_". $timestamp . "_sunrise",
							"caiyun_daily_" . $id ."_". $timestamp . "_sunset",
							...
							"caiyun_daily_" . $id ."_". $timestamp . "_weather_theday",
							"caiyun_daily_" . $id ."_". $timestamp . "_wind_level_max",
							"caiyun_daily_" . $id ."_". $timestamp . "_wind_level_avg",
							"caiyun_daily_" . $id ."_". $timestamp . "_wind_level_min",
							"caiyun_daily_" . $id ."_". $timestamp . "_humidity_max",
							"caiyun_daily_" . $id ."_". $timestamp . "_humidity_avg",
							"caiyun_daily_" . $id ."_". $timestamp . "_humidity_min",
	);
	...
	$keys = array('temp','weather','updatetime','rtemp','fengxiang','fenglevel','humidity','rweather',
				  ...
				  "cy_realtime_aqi","cy_realtime_humidity","cy_realtime_windlevel","cy_realtime_temperature",
				  "cy_sunrise","cy_sunset","cy_tempmax","cy_tempavg","cy_tempmin",
				  "cy_weather","cy_windmax","cy_windavg","cy_windmin",
				  "cy_humiditymax","cy_humidityavg","cy_humiditymin");
