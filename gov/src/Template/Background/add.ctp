...
<div class="col-lg-8">
    ...
    <?= $this->Form->create($background,['enctype' => 'multipart/form-data','class'=>'xfileupload']); ?>
            <div class="form-group input-group">
                    <span class="input-group-addon">背景系列名（这个名字其实没啥用，但是必填）</span>
            ...
            <div class="row">
                 <div class="form-group input-group" style="margin-left:20px;margin-right:40px">
                     ...
                     <?php echo $this->Form->select('reso',array("x"=>"1280x720","xx"=>"1920*1080"),['default'=>'xx','class'=>'form-control','required'=>true]); ?> 
                </div>
            </div>
...
echo $this->Html->script("upload_background.js");
?>
